      ...
      <div class="card shadow h-100 py-2" style="background: linear-gradient(to right, #ff6d00 30%, #ffb278 85%); border-radius: 0px; color: white">
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            ...
            <div class="col ml-5">
              <div class="text-xs font-weight-bold text-uppercase mb-1">Total Rides
                (Monthly)</div>
              ...
              <div class="row no-gutters align-items-center">
                ...
                <div class="col">
                  <div class="progress progress-sm ml-1">
                    <div class="progress-bar bg-light" role="progressbar" style="width: 85%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                  </div>
                </div>
              </div>
            </div>
