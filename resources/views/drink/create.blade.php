...
<div  style="margin: 0px 10px 10px 10px; padding: 10px">
	...
	<div class="card">
		...
		<div class="card-body">
			<form role="form" method="post" action=" {{route('drink.store')}} " enctype="multipart/form-data">
                @csrf
				<fieldset>
					<div class="row">
    					<div class="col-sm-6">
							<div class="form-group">
								...
								<input id="drink_name" name="name" value="{{ old('name') }}"  style="border-radius: 0px" class="form-control " required="" type="text">
								@if ($errors->has('name'))
					...
					<div class="row">
    					<div class="col-sm-6">
							<div class="form-group">
								...
								<input id="drink_price" name="price" value="{{ old('price') }}"  style="border-radius: 0px" class="form-control " required="" type="text">
								@if ($errors->has('price'))
									<span class="help-block text-danger">
					...
					<div class="form-group text-right" style="margin-top: 1rem">
						<button id="add_category" name="add_category" class="btn" style="background-color: #F6BF2D; color: black; font-weight: bold">ADD Drink</button>
					</div>
				</fieldset>
			</form>
		</div>
