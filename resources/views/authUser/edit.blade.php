...
<div style="margin: 0px 10px 10px 10px; padding: 10px">
    ...
    <div class="card">
        <div class="card-header d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0" style="color: black; font-family: serif; font-weight: bold">UPDATE ADMIN</h1>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input id="user_name" name="username" value="{{ $model->username }}" style="border-radius: 0px" class="form-control " required="" type="text">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input id="last_name" name="last_name" value="{{ $model->last_name }}" style="border-radius: 0px" class="form-control " required="" type="text">
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input id="phone" value="{{ $model->phone_number }}" name="phone_number" style="border-radius: 0px" class="form-control " required="" type="tel">
