...
return false;
        ...
        <div>
          ...
          <div class="col-sm-2">
              <input type="reset" name="Reset" value="Reset" class="btn btn-success btn-md btncustom" style="margin-left: 5px; width: 100%; border-radius:0px; border-color:black; background:black; color:#f6bf2d">
                        ...
                        </div> <input type="button" name="next" class="next action-button" value="Next" style="color: black"/>
                    </fieldset>
                    <fieldset>
                        <div class="form-card">
                            <div class="row">
                            ...
                            </div> <p style="margin: 0px 10px"><select class="form-control textInput" data-live-search="true" data-width="100%" style="width: 100%; border-radius: 0px;" id="ct_id" name="Trip[iVehicleTypeId]">
          ...
          <div class="row" style="margin: 0px 10px 10px 10px">
                    ...
                    <div class="col-sm-2" style="padding: 20px; border-radius: 40px; background-color: #eee;color:black">
                        ...
                        <div class="popup" onmouseover="myFunction()" onmouseout="myFunctionClose()"><img src="{{asset('/img/17.png')}}" width="150px" height="100px"  style="display: block;margin-left: auto; margin-right: auto">
  <span class="popuptext" id="myPopup"><small>Beef Patty, Cheese Suace, Tomato Suace <br> Onions, Mashrooms, Bun <br> PKR 890</small></span>
                    ...
                    <div class="col-sm-2" style="padding: 20px; border-radius: 40px; background-color: #eee;color:black">
                        <label>Philly Cheese Steak</label><br>
                        <img src="{{asset('/img/17.png')}}" width="150px" height="100px"  style="display: block;margin-left: auto; margin-right: auto">
                        <img src="{{asset('/img/plus-button.png')}}" width="25px" height="25px"  style="display: block;margin-left: auto; margin-right: auto">
                    </div>
                    <div class="col-sm-2" style="padding: 20px; border-radius: 40px; background-color: #eee;color:black">
                        <label>Philly Cheese Steak</label><br>
          ...
          <div class="row" style="margin: 0px 10px 10px 10px">
                    ...
                    <div class="col-sm-2" style="padding: 20px; border-radius: 40px; background-color: #eee;color:black">
                        ...
                        </div> <input type="button" name="next" class="next action-button" value="Next"  style="color: black"/> <input type="button" name="previous" class="previous action-button-previous" value="Previous" />
                    </fieldset>
                    <fieldset>
                        <div class="form-card">
                            <div class="row">
                            ...
                            </div> <p><select class="form-control textInput abcdefgh" data-live-search="true" data-width="100%" style="width: 100%; border-radius: 0px" id="ct_id"  name="Trip[iVehicleTypeId]">
      ...
      <p><textarea placeholder="Note for Rider..." class="form-control" rows="4" style="border-radius: 0px" oninput="this.className = ''" name="rider_note"></textarea></p>
          ...
          <div class="col-sm-5">
              <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d435521.40794971527!2d74.05419759728487!3d31.48263522521835!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39190483e58107d9%3A0xc23abe6ccc7e2462!2sLahore%2C%20Punjab%2C%20Pakistan!5e0!3m2!1sen!2s!4v1592141196058!5m2!1sen!2s" width="500" height="300" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
                        ...
                        </div> <input type="button" name="next" class="next action-button" value="Submit"  style="color: black"/> <input type="button" name="previous" class="previous action-button-previous" value="Previous" />
                    </fieldset>
                    <fieldset>
                        <div class="form-card">
                            <div class="row">
                   ...
                   class="d-none d-sm-inline-block btn btn-sm font-weight-bold shadow-sm" style="background-color: #FEC52E; color: black">Book a New Order!</a>
                    </fieldset>
                </form>
            </div>
        </div>
