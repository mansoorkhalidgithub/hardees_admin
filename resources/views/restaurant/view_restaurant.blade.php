					...
					<div class="row no-gutters align-items-center">
						<div class="col-auto">
							<i class="fas fa-money-bill-alt fa-3x text-light-300"></i>
                                            ...
                                            <div class="col ml-4">
							<div
								class="text-xs font-weight-bold text-uppercase mb-1">HARDEES DHA TODAY EARNING</div>
					...
					<div class="row no-gutters align-items-center">
						<div class="col-auto">
							<i class="fas fa-dollar-sign fa-2x text-light-300"></i>
                                            ...
                                            <div class="col ml-5">
							<div
								class="text-xs font-weight-bold  text-uppercase mb-1">HARDEES DHA WEEKLY EARNING</div>
					...
					<div class="row no-gutters align-items-center">
						<div class="col-auto">
							<i class="fas fa-dollar-sign fa-2x text-light-300"></i>
                                            ...
                                            <div class="col ml-5">
							<div
								class="text-xs font-weight-bold  text-uppercase mb-1">HARDEES DHA YEARLY EARNING</div>
							<div class="h5 mb-0 font-weight-bold text-light-800">$215,000</div>
						</div>
