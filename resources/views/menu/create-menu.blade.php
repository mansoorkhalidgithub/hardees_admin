                ...
                <form role="form" method="post" action="add-menu-items" enctype="multipart/form-data">
                    ...
                    <div class="row form-group category-table">
                        <div class="col col-6 col-sm-6">
                            <select placeholder="" name="menu_category_id" placeholder="name" class="form-control" required>
                           ...
                           <div class="col col-6 col-sm-6">
                            ...
                            <div class="col col-6 col-sm-6">
                            <input type="text" value="{{ old('price') }}" name="price" placeholder="price" class="form-control" required="">
                            @if ($errors->has('price'))
                                    <span class="help-block error-coor">
                                    	{{ $errors->first('price') }}
                                    </span>
...
<div class="row form-group category-table">
                        <div class="col col-6 col-sm-6">
                            <input type="text" value="{{ old('quantity') }}" name="quantity" placeholder="quantity" class="form-control" required="">
                            ...
                            <div class="col col-6 col-sm-6">
                            <input type="text" value="{{ old('discount') }}" name="discount" placeholder="Discount" class="form-control" required="">
                            ...
                            <div class="row form-group category-table">
                        <div class="col col-6 col-sm-6">
                            <input type="text" value="{{ old('weight') }}" name="weight" placeholder="weight" class="form-control" required="">
...
<option value="0">InActive</option>
                        ...
                        <div class="col col-6 col-sm-6">
                        	<label>Image</label>
                            <input type="file" value="{{ old('itemImg') }}" name="itemImg"  class="form-control" required="">
                            ...
                            <input type="checkbox" id="menuitems-is_favourite" name="is_favourite" aria-invalid="false" >
