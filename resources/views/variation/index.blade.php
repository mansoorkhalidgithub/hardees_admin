 ...
 <div style="margin: 0px 10px 10px 10px">
 	<div class="card">
 		...
 		<div class="card-header d-sm-flex align-items-center justify-content-between mb-4">
 			...
 			@endif
 			<a href="{{ route('create-menu-item') }}" class="d-none d-sm-inline-block btn btn-sm font-weight-bold shadow-sm" style="background-color: #ffc107; color: black"><i class="fas fa-fw fa-1x fa-plus fa-sm text-dark-300"></i>Add New Menu</a>
 			...
 			<table class="table table-striped table-hover" id="menu_list">
 				...
 				<tbody>
 					...
 					<tr>
 						...
 						<a href="{{ route('menu-variation', ['id' => $item->id ]) }}" class="d-none d-sm-inline btn btn-sm shadow-sm" style="background-color: #F6BF2D;cursor: pointer;"><i class="fas fa-plus"></a></i></td>
 					</tr>
 					@endforeach
