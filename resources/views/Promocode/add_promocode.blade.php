...
<div class="card-header d-sm-flex align-items-center justify-content-between mb-4">
		<h1 class="h3 mb-0" style="color: black; font-family: serif; font-weight: bold">ADD NEW PROMOCODE</h1>
...
<div class="form-group text-right" style="margin-top: 1rem">
      ...
      <button id="add_promocode" name="add_promocode" class="btn" style="background-color: #F6BF2D; color: black; font-weight: bold">ADD PROMOCODE</button>
