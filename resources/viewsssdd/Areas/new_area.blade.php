		...
		<h1 class="h3 mb-0 text-gray-800"></h1>
                <a href="{{ route('service_area') }}"
                   class="d-none d-sm-inline-block btn btn-sm shadow-sm" style="background-color:#ffc107; color: black"><i
                        class="fas fa-fw fa-1x fa-arrow-left fa-sm text-dark-300"></i> <span style="font-weight: bold">Back to Areas List</span></a>
                        
	</div-->
  <div class="card">
      <div class="card-header d-sm-flex align-items-center justify-content-between mb-4">   
          <h1 class="h3 mb-0" style="color: black; font-family: serif; font-weight: bold" >ADD NEW AREA</h1>
                <a href="{{ route('service_area') }}"
                   class="d-none d-sm-inline-block btn btn-sm shadow-sm" style="background-color:#ffc107; color: black"><i
...
<div class="form-group text-right" style="margin-top: 1rem">
      ...
      <button id="add_area" name="add_area" class="btn" style="background-color: #F6BF2D; color: black; font-weight: bold">ADD AREA</button>
