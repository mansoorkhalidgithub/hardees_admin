...
<div class="card-header d-sm-flex align-items-center justify-content-between mb-4">
		<h1 class="h3 mb-0" style="color: black; font-family: serif; font-weight: bold">Update Driver: Zahid Raza</h1>
...
<div class="row">
    ...
    <input id="phone" name="phone" style="border-radius: 0px" class="form-control " readonly="" required="" type="tel">
  ...
  <input id="email" name="email" style="border-radius: 0px" class="form-control " readonly="" required="" type="email">
...
<div class="form-group text-right" style="margin-top: 1rem">
      ...
      <button id="update_rider" name="update_rider" class="btn" style="background-color: #F6BF2D; color: black; font-weight: bold">UPDATE RIDER</button>
