                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-8 offset-md-4">
                                ...
                                <div class='form-group'>
                                 <a class="btn btn-warning" href="{{ route('request.create') }}">
                                 Create Account</a>
                                 </div>
                            </div>
                        </div>
...
<div class="container">
    ...
    <div class="row justify-content-center">
      ...
      <div class="col-xl-10 col-lg-12 col-md-9">
          ...
          <div class="card o-hidden border-2 shadow-5x my-5">
              ...
              <div class="col-lg-8">
                ...
                <div class="p-5">
                  ...
                  <div class="float-right">
                    <a class="small" href="{{ route('request.create') }}">Create Request for Account!</a>
                  </div>
