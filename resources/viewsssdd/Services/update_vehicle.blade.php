...
<div class="card-header d-sm-flex align-items-center justify-content-between mb-4">
		<h1 class="h3 mb-0"style="color: black; font-family: serif; font-weight: bold">UPDATE VEHICLE: Delivery Lahore</h1>
...
<div class="form-group text-right" style="margin-top: 1rem">
      ...
      <button id="update_vehicle" name="update_vehicle" class="btn" style="background-color: #F6BF2D; color: black;  font-weight: bold">UPDATE VEHICLE</button>
